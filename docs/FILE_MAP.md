...
| `frontend/src/components/DesignView.jsx` | Design Lab: 10 feature mockup pages (Stems, Smart Playlist, Batch Tag, Set Planner, Streaming Hub, DVS, Collab, Harmonic Mixing, Routing Matrix, Macros) + 15 selectable tileable line-pattern background themes (Beat Grid/Wave Lines/Cue Markers/Spectrum/Crosshatch/Circuit/Constellations/Sunburst/Tribal/Notes/Bold Stripes/Thick Diagonals/Arcs/Chevron/Heavy Grid) stored in localStorage |
