...
- 2026-05-18 — archived/implemented_2026-05-18 — SHIPPED (commits 159a8f8 + 739a57a): caps constants + SetReq @model_validator + SettingsManager._sanitize_loaded; 21 new tests in test_settings_caps.py; 285+ tests pass. Q11 user-implicit-signoff (defaults used). Discovered waveform_visual_mode has 4 values not 3 (rgb added per SettingsAppearance.jsx:24).
