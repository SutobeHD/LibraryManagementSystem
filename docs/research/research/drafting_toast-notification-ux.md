---
slug: toast-notification-ux
title: Toast-Notification UX — Limit, Position & Styling
owner: tb
created: 2026-06-09
...
# Toast-Notification UX — Limit, Position & Styling
...
- 2026-06-09 — `research/drafting_` — promoted; Original Idea user-reviewed, ready for `research-draft` (Scout + Prior-Art + Risk-Surface + Worker → Verifier)
...
Toast-Notifications überarbeiten. Problem: gleicher Button mehrfach geklickt erzeugt unendlich viele gestapelte Meldungen (siehe "Profile saved"-Spam im Screenshot). Gewünscht: (1) Limit auf gleichzeitig sichtbare Meldungen — Stacking begrenzen bzw. identische Meldung dedupen/zusammenfassen statt neu stapeln; (2) Position von oben-mitte nach oben-rechts verschieben; (3) Styling an den Rest der App angleichen — eckiger (weniger rund) und farblich konsistent statt der aktuellen grünen runden Pille.
