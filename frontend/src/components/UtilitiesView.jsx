...
const HEALTH_META = {
    ...
    lost: { label: 'Lost Tracks', icon: PlayCircle, color: 'text-rose-400', tip: 'Tracks that haven\'t been played yet — move to a "New Music" playlist for review.' },
    no_artwork: { label: 'No Cover', icon: ImageOff, color: 'text-ink-secondary', tip: 'Tracks missing artwork — useful to fix before exporting to USB.' },
};

const UtilitiesView = ({ mode = 'phrase', onSelectTrack, onEditTrack, onPlayTrack, libraryStatus }) => {
