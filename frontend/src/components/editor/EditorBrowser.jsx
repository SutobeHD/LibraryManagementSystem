        ...
        <div className="h-full flex flex-col bg-mx-shell/95 backdrop-blur-xl border-r border-white/10 w-80 flex-shrink-0 transition-all">
            ...
            <div className="p-4 border-b border-white/5 flex items-center justify-between">
                ...
                {onClose && (
                    <button
                        onClick={onClose}
                        className="p-1 hover:bg-white/10 rounded-full text-ink-secondary hover:text-white"
                    >
                        <X size={16} />
                    </button>
                )}
            ...
            <div className="flex-1 overflow-y-auto min-h-0 p-2 space-y-1 custom-scrollbar">
                {loading ? (
                    <div className="text-center py-8 text-ink-muted text-xs animate-pulse">
                        Loading library...
                    </div>
                ) : filteredTracks.length === 0 ? (
                    <div className="text-center py-8 text-ink-placeholder text-xs">
                        No tracks found
                    </div>
                ) : (
