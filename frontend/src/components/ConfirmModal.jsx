/* eslint-disable react-refresh/only-export-components -- confirmModal() is the imperative entry point for the dialog rendered by this same module — splitting them would separate an API from the component that implements it */
