...
export default function ConfirmModal({ modal, setModal }) {
    ...
    return (
        <div
            className="absolute inset-0 z-[200] flex items-center justify-center bg-black/70 backdrop-blur-sm animate-fade-in"
            onClick={() => setModal(null)}
        >
            <div
                className="w-[420px] glass-panel border border-white/10 rounded-2xl p-6 shadow-2xl"
