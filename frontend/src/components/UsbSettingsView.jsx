        ...
        return (
            <div className="h-full flex items-center justify-center">
                <div className="mx-card p-6 max-w-md text-center">
                    ...
                    <div className="text-ink-primary font-semibold mb-1">
                        USB Settings unavailable
                    </div>
                ...
                {slow && (
                    <div className="mt-1 max-w-xs flex flex-col items-center gap-3">
                        <div className="text-tiny text-ink-muted">
                            This is taking longer than usual — a disconnected or unreadable drive
                            can stall the scan.
                        </div>
                        <button
                            onClick={() => setReloadKey((k) => k + 1)}
        ...
        return (
            <div className="h-full flex items-center justify-center">
                <div className="mx-card p-6 max-w-md text-center">
                    ...
                    <div className="text-tiny text-ink-muted">
                        Plug in a USB drive — its profile will appear here automatically once it is
                        initialised.
                    </div>
                </div>
            </div>
            ...
            <div className="px-6 py-4 border-b border-line-subtle flex-shrink-0">
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-tiny text-ink-muted">
                        CDJ player &amp; DJM mixer behaviour, written into{' '}
                        <code className="bg-mx-input px-1.5 py-0.5 rounded text-[10px]">
                    ...
                    >
                        {allDevices.map((d) => (
                            <option key={d.device_id} value={d.device_id}>
                                {d.label || d.device_id} {d.drive ? `(${d.drive})` : ''}{' '}
                                {d._offline ? '— offline' : ''}
                            </option>
                        ))}
                    </select>
