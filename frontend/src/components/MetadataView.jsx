...
const MetadataView = ({
    ...
    // Artist merges leave this view: they rewrite master.db rows, audio tags and the
    // USB layout, so they go through the Artist-Hub dialog (preview + journal +
    // revert). Labels and albums keep the alias-only mapping merge below.
    const [mergeArtist, setMergeArtist] = useState(null);
    ...
    return (
        <div className="h-full flex flex-col p-4">
                        ...
                        <div className="min-w-0">
                            <h1 className="text-2xl font-bold text-white flex items-center gap-2.5 truncate">
                                {activeTab === 'artists' ? (
                                    ...
                                    <Tag size={26} className="text-purple-400 shrink-0" />
                                ) : (
                            ...
                            <p className="text-ink-secondary text-sm mt-0.5">
                                ...
                                {selectedItem.track_count || tracks.length} Tracks
                            </p>
                        </div>
                    </div>
                ) : (
                ...
                <div className="flex items-center gap-3 shrink-0">
                    ...
                    <div className="relative group w-64">
                        ...
                        <input
                            ...
                            placeholder={
                                selectedItem ? 'Search tracks...' : `Search ${activeTab}...`
                            }
            ...
            {mergeArtist !== null && (
                <MergeDialog
                    seedName={mergeArtist}
                    onClose={() => setMergeArtist(null)}
                    onApplied={loadItems}
                />
            )}
        </div>
